...
public class SecurityConfig {
	...
	public SecurityFilterChain authorizeRequests(HttpSecurity http) throws Exception
	{
		...
		.and().
		authorizeRequests()
		.antMatchers("/user/register","/user/login","user/home","/all/**",
		...
		.antMatchers("/admin-seller/**").hasAnyRole("ADMIN","SELLER")
		.antMatchers("/Images/FeaturedProducts/**").permitAll() // Allow access to static images
        .and()
